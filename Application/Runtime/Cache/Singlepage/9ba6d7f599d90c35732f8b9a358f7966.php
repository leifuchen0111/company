	...
	<div class="span12">
		...
		<div class="portlet box blue">
			...
			<div class="portlet-title">
				...
				<div class="caption"><i class="icon-reorder"></i>下载地址</div>
			...
			<div class="portlet-body form">
				...
				<form action="<?php echo U('save');?>" class="form-horizontal" method="post" enctype="multipart/form-data">
					...
					<div class="control-group">
						...
						<label class="control-label">android版地址<span class="required">*</span></label>

						<div  class="controls">

							<input type="text" class="form-control" name="android" value="<?php echo ($link["android"]); ?>">
							<span class="help-inline">如果为下载链接，请将地址填入此处</span>
						</div>
					...
					<div class="control-group">
						...
						<label class="control-label">android版文件<span class="required">*</span></label>

						<div class="controls">

							<input type="file" class="form-control" name="android">
							<span class="help-block alert-danger">此处与下载链接两项填写一项即可，如果都填写，默认为文件格式</span>
						</div>
					...
					<div class="control-group">
						...
						<label class="control-label">选择andriod下载格式<span class="required">*</span></label>

						<div class="controls">
							<label class="radio">
								<input type="radio" value="link" <?php if(($link["type"]) == "link"): ?>checked<?php endif; ?> name="type">下载链接
							</label>
							<label class="radio">

								<input type="radio" value="file" <?php if(($link["type"]) == "file"): ?>checked<?php endif; ?> name="type">下载文件
							</label>
					...
					<div class="control-group">
						...
						<label class="control-label">IOS版地址<span class="required">*</span></label>

						<div class="controls">

							<input type="text" value="<?php echo ($link["ios"]); ?>" required class="span6 m-wrap" name="ios">

							<span class="help-inline">请填写在appstore的下载地址</span>
