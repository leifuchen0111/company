				...
				<form action="<?php echo U('save');?>" class="form-horizontal" method="post">
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<input type="text" value="<?php echo ($data["ssid"]); ?>" class="span6 m-wrap" name="ssid">
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<input type="text" value="<?php echo ($data["gw_id"]); ?>" class="span6 m-wrap" name="gw_id">
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<input readonly type="text" value="<?php echo ($data["tpl_style"]); ?>" required class="span6 m-wrap">
