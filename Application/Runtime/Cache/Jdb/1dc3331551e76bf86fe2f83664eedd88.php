	...
	<div class="span12 responsive" data-tablet="span12 fix-offset" data-desktop="span12">
		...
		<div class="portlet box blue">
			...
			<div class="portlet-title">
				...
				<div class="caption"><i class="icon-list"></i>邀请码</div>

				<div class="actions">

					<a href="<?php echo U('Code/add',array('gw_id'=>$gw_id,'webid'=>$webid));?>" class="btn red"><i class="icon-plus"></i> 添加</a>
					...
					<div class="btn-group">
						...
						<!-- 	<li id="edit" action="<?php echo U('Nac/navEdit');?>"><a href="<?php echo U('Nac/navEdit');?>"><i class="icon-pencil"></i> 编辑</a></li> -->
							...
							<li id="del" action="<?php echo U('Code/del');?>"><a href="javascript:;"><i class="icon-trash"></i> 删除</a></li>
				...
				<table class="table table-striped table-bordered table-hover" id="sample_2">
					...
					<tbody>
						...
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
							...
							<td><a href="<?php echo ($vo["img"]); ?>" target="_blank" class="btn blue">查看</a></td>
							<td><?php echo ($vo["displayorder"]); ?></td>
							<td><a href="<?php echo U('edit',array('gw_id'=>$gw_id,'webid'=>$webid,'id'=>$vo['id']));?>" class="btn blue"><i class="icon-pencil"></i></a></td>
