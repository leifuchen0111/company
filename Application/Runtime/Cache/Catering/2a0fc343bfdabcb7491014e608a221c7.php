	...
	<div class="span12 responsive" data-tablet="span12 fix-offset" data-desktop="span12">
		...
		<div class="portlet box blue">
			...
			<div class="portlet-title">
				...
				<div class="caption"><i class="icon-list"></i>新闻列表</div>

				<div class="actions">

					<a href="<?php echo U('News/add',array('gw_id'=>$gw_id,'webid'=>$webid));?>" class="btn red"><i class="icon-plus"></i> 添加</a>
					...
					<tbody>
						...
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
							...
							<td>
								...
								<a href="<?php echo U('edit',array('gw_id'=>$gw_id,'webid'=>$webid,'id'=>$vo['id']));?>" class="btn blue"><i class="icon-pencil"></i>编辑</a>

								<a href="<?php echo U('preview',array('gw_id'=>$gw_id,'webid'=>$webid,'id'=>$vo['id']));?>" class="btn blue"><i class="icon-pencil"></i>预览</a>
							</td>
