	...
	<div class="span12">
		...
		<div class="portlet box blue">
			...
			<div class="portlet-title">
				...
				<div class="actions">
					<a href="<?php echo U('Ads/ads',array('gw_id'=>$gw_id,'webid'=>$webid));?>" class="btn red"><i class="icon-long-arrow-left"></i>广告列表</a>
				</div>
			</div>
			...
			<div class="portlet-body form">
				...
				<form action="<?php echo U('save');?>" class="form-horizontal" method="post" enctype="multipart/form-data">
					...
					<div class="control-group">
						...
						<input type="hidden" name="image" value="<?php echo ($ad["img"]); ?>">
					...
					<?php if(($ad["image"]) != ""): ?><div class="control-group">
