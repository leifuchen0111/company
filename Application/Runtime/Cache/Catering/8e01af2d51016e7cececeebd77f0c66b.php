	...
	<div class="span12 responsive" data-tablet="span12 fix-offset" data-desktop="span12">
		...
		<div class="portlet box blue">
			...
			<div class="portlet-title">
				...
				<div class="caption"><i class="icon-list"></i><?php echo ($types[$type]); ?>列表</div>

				<div class="actions">

					<a href="<?php echo U('Ads/Add',array('gw_id'=>$gw_id,'webid'=>$webid));?>" class="btn red"><i class="icon-plus"></i> 添加</a>
				...
				<table class="table table-striped table-bordered table-hover" id="sample_2">
					...
					<tbody>
						...
						<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
							...
							<td><a href="<?php echo ($vo["image"]); ?>" target="_blank" class="btn blue">查看</a></td>
