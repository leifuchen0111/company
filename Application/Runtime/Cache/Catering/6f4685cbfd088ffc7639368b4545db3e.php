	...
	<div class="span12 responsive" data-tablet="span12 fix-offset" data-desktop="span12">
		...
		<div class="portlet box grey">
			...
			<div class="portlet-title">
				...
				<div class="caption"><i class="icon-user"></i><?php echo ($types[$type]); ?>分类</div>

				<div class="actions">

					<a href="<?php echo U('CatePro/add',array('webid'=>$webid,'gw_id'=>$gw_id,'type'=>$type));?>" class="btn blue"><i class="icon-pencil"></i> 添加</a>
			...
			<div class="portlet-body">
				...
				<table class="table table-striped table-bordered table-hover" id="sample_2">
					...
					<tbody>
						<?php if(is_array($cates)): $i = 0; $__LIST__ = $cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
							...
							<td>
							<?php if(($vo["image"]) != ""): ?><a class="btn blue" href="<?php echo ($vo["image"]); ?>" target="_blank">查看</a>
							<?php else: ?>
								无<?php endif; ?>
							</td>

							<td class="hidden-480">
								<a href="<?php echo U('CatePro/edit',array('id'=>$vo['id'],'gw_id'=>$gw_id,'webid'=>$webid));?>">编辑</a>
