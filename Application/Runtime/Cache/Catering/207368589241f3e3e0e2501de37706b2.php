	...
	<div class="span12">
		...
		<div class="portlet box blue">
			...
			<div class="portlet-title">
				...
				<a class="btn green pull-right" href="<?php echo U('Pro/pro',array('gw_id'=>$gw_id,'webid'=>$webid));?>"><i class="icon icon-list"></i>商品列表</a>
			...
			<div class="portlet-body form">
				...
				<form action="<?php echo U('Pro/save');?>" class="form-horizontal" method="post" enctype="multipart/form-data">
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<select class="" name="cate_id">
								<?php if(is_array($cates)): $i = 0; $__LIST__ = $cates;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><option value="<?php echo ($item["id"]); ?>" <?php if($item['id']==$pro['cate_id']) echo 'selected'; ?>><?php echo ($item["category"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
							</select>
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<input type="text" required class="span6 m-wrap" name="name" value="<?php echo ($pro["name"]); ?>">
					...
					<div class="control-group">
						...
						<div class="controls">
							...
							<?php if($pro['image'] != ''){ echo '<img width="100" src="'.$pro['image'].'">'; } ?>
					...
					<script type="text/javascript">
						 ...
						 */
						$('#as').diyUpload({
							url:'/Tool/Tool/fileupload/path/<?php echo ($savePath); ?>',
							success:function( data ) {
								$('input[name=image]').val(data.path+data.filename);
							},
							error:function( err ) {
								console.info( err );
							},
