...
<html>
  <head>
    ...
    <!-- Bootstrap -->
    <link href="/Public/Wifidog/bootstrap.css" rel="stylesheet">    
    <link href="/Public/Wifidog/siqnin.css" rel="stylesheet">
    <script src="/Public/Wifidog/jquery.js"></script>
    <script>
  ...
  <body>
    ...
    <div class="container top">
		...
		<div class="well" id="byWb" style="display:none" >
                    ...
                    <h5>请关注本店微信公众号:<code><?php echo ($wx_name); ?></code>，即可享受高速上网服务</h5>
                    <img src="<?php echo ($qrcode); ?>" width="300" style="margin:auto;display:block;">
        </div>
		<?php } ?>
    </div>
