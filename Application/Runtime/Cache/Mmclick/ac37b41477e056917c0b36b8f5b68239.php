                ...
                <div class="tab-pane active" id="tab_4">
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-title">
                            ...
                            <div class="caption"><i class="icon-reorder"></i>mmclick图片上传</div>
                            <div class="tools">
                            </div>
                        ...
                        <div class="portlet-body form">
                            ...
                            <form action="<?php echo U('Index/save');?>" enctype="multipart/form-data" method="post" class="form-horizontal">
