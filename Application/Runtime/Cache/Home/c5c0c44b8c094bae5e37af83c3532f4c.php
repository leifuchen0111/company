	...
	<div class="span12">
		...
		<div class="portlet box blue">
			...
			<div class="portlet-body form">
				...
				<form action="<?php echo U('WebMag/webSave');?>" class="form-horizontal" method="post"
					...
					<div class="control-group">
						...
						<div class="control-group">
							<label class="control-label">请选择SSID</label>
							<div class="controls">
								<select class="large m-wrap" name="ssid" tabindex="1">
									<?php if(is_array($ssid)): $i = 0; $__LIST__ = $ssid;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["ssid"]); ?>"><?php echo ($vo["ssid"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
								</select>
							</div>
						</div>
