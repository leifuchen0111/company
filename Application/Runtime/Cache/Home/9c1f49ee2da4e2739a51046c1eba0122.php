	...
	<div class="span12 responsive" data-tablet="span12 fix-offset" data-desktop="span12">
		...
		<div class="portlet box blue">
			...
			<div class="portlet-title">
				...
				<div class="caption"><i class="icon-edit"></i>热点列表</div>
				
				<div class="actions">
					
					<a href="/Home/Ssid/appSsid/id/<?php echo ($apInfo["id"]); ?>/gw_id/<?php echo ($apInfo["gw_id"]); ?>" class="btn green"><i class="icon-rss"></i> 推送</a>
					<a href="/Home/Ssid/ssidAdd/id/<?php echo ($apInfo["id"]); ?>/gw_id/<?php echo ($apInfo["gw_id"]); ?>" class="btn green"><i class="icon-plus"></i> 添加</a>
					<div class="btn-group">
						...
						<!-- 	<li id="edit" action="editUsers"><a href="/Home/Ssid/editUsers/id/"><i class="icon-pencil"></i> 编辑</a></li> -->
						
							<li id="del" action="<?php echo U('Ssid/delSsids');?>"><a href="javascript:;"><i
			...
			<div class="portlet-body">
				...
				<table class="table table-striped table-bordered table-hover" id="sample_2">
					...
					<tbody>
						<?php if(is_array($ssid)): $i = 0; $__LIST__ = $ssid;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ap): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
							
							<td><input type="checkbox" class="checkboxes" value="<?php echo ($ap["id"]); ?>" /></td>
							

							<td><?php echo ($ap["ssid"]); ?> (<?php echo ($ap["channel"]); ?>)</td>

							<td  class="hidden-480"><?php if(($ap["psd"]) != ""): echo ($ap["psd"]); else: ?>无<?php endif; ?></td>

							<td><?php if(($ap["state"]) == "1"): ?><span class="label label-warning">等待执行</span><?php else: ?><span class="label label-success">已添加到路由器</span><?php endif; ?></td>
...
<div class="row-fluid now">

	<div class="help-block span3 pull-left">当前信道  :  2.4g -- <?php echo ($xChannel["2c"]); ?>&nbsp;&nbsp; 5g -- <?php echo ($xChannel["5c"]); ?></div>
	<a id="setChannel" class="blue lable" href="javascript:;"><i
		class="icon-pencil">
	</i>设置</a>
</div>
<script>
				...
				<div class="tab-pane active" id="tab_4">
					...
					<div class="portlet box blue">
						...
						<div class="portlet-title">
							...
							<div class="caption"><i class="icon-reorder"></i>信道设置</div>
						...
						<div class="portlet-body form">
							...
							<form action="<?php echo U('Ssid/xchannel');?>" method="post" class="form-horizontal">

								<div class="control-group">

									<label class="control-label">2.4g信道</label>

									<div class="controls">

										<input type="text"  pattern="([1-9]{1}|10|11)" placeholder="2.4g信道" name="2c" value="<?php echo ($data['2c']); ?>" class="m-wrap span6">

										<span class="help-inline">可用信道:1-11</span>
								...
								<div class="control-group">
									...
									<label class="control-label">5g信道</label>

									<div class="controls">

										<input type="text" pattern="(149|153|157|161)"  placeholder="5g信道" name="5c" value="<?php echo ($data['5c']); ?>" class="m-wrap span6">

										<span class="help-inline">可用信道:149、153、157、161</span>
