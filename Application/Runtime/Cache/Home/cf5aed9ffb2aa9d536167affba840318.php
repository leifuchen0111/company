...
<form action="/home/member/editagent" method="post" id="form_sample_1" class="form-horizontal" novalidate="novalidate">
<?php if(is_array($member)): $i = 0; $__LIST__ = $member;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mem): $mod = ($i % 2 );++$i;?><div class="row-fluid">
			...
			<div class="span12">
				...
				<div class="portlet box purple">
					...
					<div class="portlet-title">
						...
						<div class="caption"><i class="icon-reorder"></i>会员<strong><?php echo ($mem["name"]); ?></strong>的信息</div>
									...
									<div class="tab-pane active" id="tab1">
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<input type="text" value="<?php echo ($mem["name"]); ?>" readonly class="span6 m-wrap" placeholder="Username" name="name_<?php echo ($mem["id"]); ?>">
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<input type="password" placeholder="Password" class="span6 m-wrap" name="password_<?php echo ($mem["id"]); ?>" id="submit_form_password">

												<span class="help-inline">留空则不修改密码</span>
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<input type="password" placeholder="Confirm Password" class="span6 m-wrap" name="repassword_<?php echo ($mem["id"]); ?>">

												<span class="help-inline">若不修改密码，则此项留空</span>
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<input type="email" value="<?php echo ($mem["email"]); ?>" placeholder="Email" class="span6 m-wrap" name="email_<?php echo ($mem["id"]); ?>">

												<span class="help-inline">填写联系邮箱</span>
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<input type="text" value="<?php echo ($mem["phone"]); ?>" placeholder="Phone" class="span6 m-wrap" name="phone_<?php echo ($mem["id"]); ?>">

												<span class="help-inline">填写联系手机号</span>
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<input type="text" value="<?php echo ($mem["address"]); ?>" placeholder="Address" class="span6 m-wrap" name="address_<?php echo ($mem["id"]); ?>">

												<span class="help-inline">填写联系地址</span>
										...
										<div class="control-group">
											...
											<div class="controls">
												...
												<select class="large m-wrap" name="roleid_<?php echo ($mem["id"]); ?>" required tabindex="1">

													<?php if(is_array($role)): $i = 0; $__LIST__ = $role;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><option <?php if(($mem["role_id"]) == $v["id"]): ?>selected<?php endif; ?> value="<?php echo ($v["id"]); ?>"><?php echo ($v["role"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
