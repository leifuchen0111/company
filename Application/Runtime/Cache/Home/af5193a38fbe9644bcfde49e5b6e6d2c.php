		...
		<div class="portlet box yellow">
			...
			<div class="portlet-body">
				...
				<table class="table table-striped table-bordered table-hover" id="sample_3">
					...
					<tbody>
						<?php if(is_array($member)): $i = 0; $__LIST__ = $member;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
							...
							<td><a class="btn link" href="<?php echo U('Dashboard/member',array('pid'=>$v['id']));?>"><?php echo ($v["chcount"]); ?></td>

							<td align="center">

								<a href="<?php echo U('Member/editAgent',array('id'=>$v['id']));?>" class="btn blue icn-only"><i class="icon-pencil icon-white"></i>&nbsp;&nbsp;编辑</a>

								<a href="<?php echo U('Member/edit',array('id'=>$v['id']));?>" class="btn green icn-only">&nbsp;&nbsp;详情</a>
