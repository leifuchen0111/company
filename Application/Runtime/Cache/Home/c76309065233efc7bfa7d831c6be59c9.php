	...
	<div class="span12 responsive" data-tablet="span12 fix-offset" data-desktop="span12">
		...
		<div class="portlet box grey">
			...
			<div class="portlet-title">
				...
				<div class="caption"><i class="icon-user"></i>站点列表</div>

				<div class="actions">

					<a href="<?php echo U('WebMag/webAdd',array('gw_id'=>$apInfo['gw_id']));?>"
					   class="btn blue"><i
							class="icon-pencil"></i> 添加</a>
					...
					<div class="btn-group">
						...
						<ul class="dropdown-menu pull-right">
							...
							<li id="del" action="<?php echo U('WebMag/delWebsite',array('gwId'=>$apInfo['gw_id']));?>"><a
									href="javascript:;"><i
			...
			<div class="portlet-body">
				...
				<table class="table table-striped table-bordered table-hover" id="sample_3">
					...
					<tbody>
						...
						<?php if(is_array($websites)): $i = 0; $__LIST__ = $websites;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ap): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">

							<td><input type="checkbox" class="checkboxes" value="<?php echo ($ap["id"]); ?>" /></td>

							<td><?php echo ($ap["id"]); ?></td>

							<td><?php echo ($ap["web_name"]); ?></td>

							<td><?php echo ($ap["ssid"]); ?></td>

							<td class="hidden-480"><?php echo ($ap["tpl_style"]); ?></td>
							<!-- /Webbuild/index.php/Index/webconf/webid/<?php echo ($ap["id"]); ?> -->
							<td>
								<?php if(in_array(($ap["tpl_style"]), is_array($tpls)?$tpls:explode(',',$tpls))): ?><a class="btn blue" href="<?php echo U($ap['tpl_style'].'/Index/index',array('gw_id'=>$apInfo['gw_id'],'webid'=>$ap['id']));?>">管理</a>
								<?php else: ?>
									<a class="btn blue" href="<?php echo U('We/Index/webconf',array('webid'=>$ap['id'],'gw_id'=>$apInfo['gw_id']));?>">管理</a><?php endif; ?>
								<a class="btn blue" href="<?php echo U('WebMag/setWx',array('webid'=>$ap['id'],'gw_id'=>$apInfo['gw_id']));?>">绑定微信</a>
								<a class="btn blue" href="<?php echo U('WebMag/copy',array('webid'=>$ap['id'],'gw_id'=>$apInfo['gw_id']));?>">复制</a>
							</td>
