...
<?php if(is_array($sysnews)): $i = 0; $__LIST__ = $sysnews;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><div class="row-fluid">
	...
	<div class="span12">
		...
		<div class="portlet box purple">
			...
			<div class="portlet-title">
				...
				<div class="caption"><i class="icon-reorder"></i><?php echo ($item["title"]); ?> <?php echo (date("Y/m/d",$item["posttime"])); ?></div>
