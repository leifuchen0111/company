	...
	<div class="span12">
		...
		<div class="portlet box blue">
			...
			<div class="portlet-title">
				...
				<div class="caption"><i class="icon-reorder"></i>上传EXCEL文件</div>
			...
			<div class="portlet-body form">
				...
				<form action="<?php echo U('ApMain/import');?>" class="form-horizontal" method="post" enctype="multipart/form-data">
						...
						<div class="controls">
							...
							<div class="fileupload fileupload-new" data-provides="fileupload">
								...
								<div class="input-append">
									...
									<input type="file"  name="import" class="default" />
