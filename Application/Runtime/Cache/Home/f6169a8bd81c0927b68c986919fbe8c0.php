	...
	<div class="span12 responsive" data-tablet="span12 fix-offset" data-desktop="span12">
		...
		<div class="portlet box grey">
			...
			<div class="portlet-title">
				...
				<div class="caption"><i class="icon-user"></i>固件列表</div>
			...
			<div class="portlet-body">
				...
				<table class="table table-striped table-bordered table-hover" id="sample_2">
					...
					<tbody>
						<?php if(is_array($fw)): $i = 0; $__LIST__ = $fw;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ap): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">

							<td><input type="checkbox" class="checkboxes" value="<?php echo ($v["id"]); ?>" /></td>
							<td><?php echo ($ap["version"]); ?></td>

							<td><?php echo (date("Y-m-d",$ap["create_time"])); ?></td>
							
							<td><?php echo ($ap["mode"]); ?></td>
							
							<td class="hidden-480" style="max-width:200px;"><?php echo ($ap["desc"]); ?></td>
