...
<div class="row-fluid">
	...
	<div class="span3 responsive" data-tablet="span3 fix-offset" data-desktop="span3">
		<div class="portlet box green">
			...
			<div class="portlet-body">
				...
				<a class="btn btn-block  blue" href="<?php echo U('user');?>">全部数据列表<i class="m-icon-swapright m-icon-white"></i></a>
				<a class="btn btn-block  blue" href="<?php echo U('user',array('start'=>strtotime(date('Y-m-d',time()))));?>">今日统计<i class="m-icon-swapright m-icon-white"></i></a>
				<a class="btn btn-block  blue" href="<?php echo U('user',array('start'=>strtotime(date('Y-m-d',time()))-24*3600));?>">昨日统计<i class="m-icon-swapright m-icon-white"></i></a>
				<a class="btn btn-block  blue" href="<?php echo U('user',array('start'=>strtotime(date('Y-m-d',time()))-7*24*3600));?>">7天内统计<i class="m-icon-swapright m-icon-white"></i></a>
				<a class="btn btn-block  blue" href="<?php echo U('user',array('start'=>strtotime(date('Y-m-d',time()))-30*24*3600));?>">本月统计<i class="m-icon-swapright m-icon-white"></i></a>
			</div>
	...
	<div class="span9 responsive" data-tablet="span9 fix-offset" data-desktop="span9">
		...
		<div class="portlet box green">
			...
			<div class="portlet-title">
				...
				<div class="caption"><i class="icon-user"></i>认证用户</div>
			...
			<div class="portlet-body">
				...
				<table class="table table-striped table-bordered table-hover" id="sample_3">
					...
					<tbody>
						...
						<?php if(is_array($maclist)): $i = 0; $__LIST__ = $maclist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
							...
							<td><?php echo (str_time($v['ltime']-$v['stime'])); ?></td>
