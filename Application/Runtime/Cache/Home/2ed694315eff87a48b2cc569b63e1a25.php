		...
		<div class="span12">
			...
			<div class="portlet box green">
				...
				<div class="portlet-title">
					...
					<div class="caption"><i class="icon-reorder"></i>站点复制</div>
				...
				<div class="portlet-body form">
					...
					<form action="/home/webmag/copy" method="post" class="form-horizontal">

						<div class="control-group span12">

							<div class="controls">

								<select multiple="multiple" style="height:600px;" id="" class="span6" name="ssid[]">
									<?php if(is_array($ap)): foreach($ap as $k=>$v): ?><optgroup label="<?php echo ($k); ?>">

											<?php if(is_array($v)): foreach($v as $key=>$s): ?><option><?php echo ($k); ?>_<?php echo ($s); ?></option><?php endforeach; endif; ?>
										</optgroup><?php endforeach; endif; ?>
								</select>
								<span class="help-inline">请选择路由器和对应ssid</span>
							</div>
