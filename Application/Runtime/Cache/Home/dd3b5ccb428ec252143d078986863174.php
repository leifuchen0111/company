	...
	<div class="span12 responsive" data-tablet="span12 fix-offset" data-desktop="span12">
		...
		<div class="portlet box grey">
			...
			<div class="portlet-title">
				...
				<div class="caption"><i class="icon-user"></i>商户列表</div>

				<div class="actions">
					
					<a href="<?php echo U('Member/agent');?>" class="btn yellow"><i class="icon-share-alt"></i> 运营商管理</a>

					<a href="<?php echo U('Member/addUser');?>" class="btn blue"><i class="icon-pencil"></i> 添加</a>
					...
					<!--<div class="btn-group">
						...
						<ul class="dropdown-menu pull-right">
							<?php if(($htmlUser['editUser']) == "1"): ?><li id="edit" action="<?php echo U('Member/editUser');?>"><a href="javascript:;"><i class="icon-pencil"></i> 编辑</a></li><?php endif; ?>
							<?php if(($htmlUser['delUser']) == "1"): ?><li id="del" action="<?php echo U('Member/delUsers');?>"><a href="#"><i class="icon-trash"></i> 删除</a></li><?php endif; ?>
							<?php if(($htmlUser['banUser']) == "1"): ?><li><a href="#"><i class="icon-ban-circle"></i>禁用</a></li><?php endif; ?>
							<li class="divider"></li>
			...
			<div class="portlet-body">
				...
				<table class="table table-striped table-bordered table-hover" id="sample_2">
					...
					<tbody>
						<?php if(is_array($userList)): $i = 0; $__LIST__ = $userList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
