	...
	<div class="span12 responsive" data-tablet="span12 fix-offset" data-desktop="span12">
		...
		<div class="portlet box grey">
			...
			<div class="portlet-title">
				...
				<div class="caption"><i class="icon-user"></i>在线用户列表</div>
				...
				<div class="actions">
					...
					<div class="btn-group">
						...
						<ul class="dropdown-menu pull-right">
							...
							<li id="offLine"  action="<?php echo U('Mac/offLine');?>"><a href="javascript:;"><i class="icon-ban-circle"></i>强制下线</a></li>
				...
				<table class="table table-striped table-bordered table-hover" id="sample_2">
					...
					<thead>
						...
						<tr>
							...
							<th class="hidden-480">认证时间</th>
							
							<th>在线时间</th>
							
							<th class="hidden-480">上传流量</th>

							<th class="hidden-480">下载流量</th>
					...
					<tbody>
						<?php if(is_array($maclist)): $i = 0; $__LIST__ = $maclist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
							...
							<td  class="hidden-480"><?php echo ($v["mac"]); ?></td>

							<td class="hidden-480"><?php echo (date("Y-m-d",$v["stime"])); ?></td>
							
							<td><?php echo (str_time($v['ltime']-$v['stime'])); ?></td>
							
							<td  class="hidden-480"><?php echo (byt_to_m($v["bw"]["bw_up"])); ?></td>
							
							<td  class="hidden-480"><?php echo (byt_to_m($v["bw"]["bw_down"])); ?></td>
