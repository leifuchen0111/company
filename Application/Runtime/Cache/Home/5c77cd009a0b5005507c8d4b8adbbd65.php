	...
	<div class="span12 responsive" data-tablet="span12 fix-offset" data-desktop="span12">
		...
		<div class="portlet box grey">
			...
			<div class="portlet-title">
				...
				<div class="actions">
					<?php if(($htmlUser['addRole']) == "1"): ?><a href="/Home/Role/addRole" class="btn green"><i class="icon-plus"></i> 添加</a><?php endif; ?>
					...
					<div class="btn-group">
						...
						<ul class="dropdown-menu pull-right">
							<?php if(($htmlUser['editRole']) == "1"): ?><li id="edit" action="<?php echo U('Role/editRole');?>"><a href="javascript:;"><i class="icon-pencil"></i> 编辑</a></li><?php endif; ?>
							<?php if(($htmlUser['delRole']) == "1"): ?><li id="del" action="<?php echo U('Role/delRole');?>"><a href="javascript:;"><i class="icon-trash"></i> 删除</a></li><?php endif; ?>
							<li class="divider"></li>
						</ul>
			...
			<div class="portlet-body">
				...
				<table class="table table-striped table-bordered table-hover" id="sample_2">
					...
					<tbody>
						<?php if(is_array($role)): $i = 0; $__LIST__ = $role;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
							...
							<td align="center">
								...
								<a href="/Home/Role/editRole/id/<?php echo ($v["id"]); ?>" class="btn blue icn-only"><i class="icon-pencil icon-white"></i>&nbsp;&nbsp;编辑权限</a>
								
								<a href="javascript:deleteOne(<?php echo ($v["id"]); ?>,'/Home/Role/delRole/id/');" class="btn red icn-only"><i class="icon-remove icon-white"></i>&nbsp;&nbsp;删除</a>
